...
apt-get update && \
apt-get install -y apt-utils procps less nano curl git zip netcat-openbsd net-tools mariadb-client postgresql-client ssmtp php-fpm php-mysql php-pgsql php-mbstring php-opcache php-mcrypt php-pear php-curl composer phpunit phpunit-dbunit php-invoker php-xdebug && \
apt-get clean
